...
for %%a in (
	...
	"- Dodano tryb [0;1;40;36mFullScreen[0;1;40;37m. Aby go uruchomiÜ, przejd´ do ustawie‰"
	"- Dodano tryb [0;40;32m"CPU-Saver"[0;1;40;37m do CreepyCrafta"
	"-- Dzi©ki temu powinna gra dziaàaÜ znacznie szybciej"
...
set "__MenuSettings7=Wà•cz tryb FullScreen"
set "__MenuSettings8=Zapisz i wr¢Ü do menu"
set "__MenuFullScreen1=Trwa uruchamianie trybu Full-Screen..."
set "__MenuFullScreen2=Jeæeli program si© zawiesi, to znaczy æe tw¢j system nie lubi tego trybu :("
set "__MenuFullScreen3=Jeæeli program si© zawiesi, wyà•cz tryb usuwaj•c plik Settings.ini"
set "__Prompt=Wyb¢r: "
...
set "__CB_CPUSaver2=   Wciònij 'S' aby zmieniÜ stan."
set "__CB_CPUSaver3=Wà•czony"
set "__CB_CPUSaver4=Wyà•czony"
...
:PE_var
	...
	for %%c in (
	"[24;1H[;m"
	"⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒø⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø[25;1H"
	"≥Colors:       ≥Brightness≥≥Brushes:[#]                              ≥[26;1H"
	"≥BG:        [ ]≥[ ][ ][ ] ≥≥€ ≤ ± ∞ ‹ ﬂ    ⁄ ƒ ø ¿ Ÿ © ∏ … Õ ª Œ »≥[27;1H"
	"≥FG:        [ ]≥[ ][ ][ ] ≥≥         ¡ ¬ √ ≈ ¥ ≥ Æ Ø π ∫ º  ≥[28;1H"
	"≥BF:-  -  - [ ]≥ 0  1  5  ≥≥ ˛ ÿ     ™     ˜ Ó Ô  ˘ ˙ œ Ã À≥[29;1H"
	"¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒŸ¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ"
	) do set "p2=!p2!%%~c"
	set "bar.color=[26;5H!bar.cl![27;5H!bar.cl!"
	for /l %%a in (5,1,23) do set "sp=!sp!≥                                                                    ≥[%%a;1H"
	for %%a in (
	"[3;1H[0;1;40;32m"
	"⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø[4;1H"
	"!sp!"
