...
set Menu1Name6=CraftBatcher (by Suchar)
...
cls
if not defined ANSIcon_Enabled set __MenuConflict1=I see that you are using Windows 8.1.&set __MenuConflict2=System faults cause program not to work properly.&set __MenuConflict3=To solve this, launch program as administrator.
...
for %%a in (
	...
	"- Usuni©to [0;40;33mTest Samples[0;1;40;37m"
	""
	""
	"CreepyGames v1.4.2 (aktualna)"
...
set "__MenuConflict3=Aby je rozwi•zaÜ, uruchom program jako administrator."
...
set "__CC_Error1a=  Opis bledu: Uøyto komendy ^>nul"
set "__CC_Error1b=    Bπdü tekst wyjúciowy jest"
set "__CC_Error1c=         przekierowywany"
set "__CC_Error2a=    Opis bledu: B≥πd podczas"
set "__CC_Error2b=     konfiguracji programu."
set "__CC_Error3a=    Opis bledu: B≥πd podczas"
...
set "__CC_str3=Remis (przyznaj po pÛ≥ punktu)"
set "__CC_str6=miejsce zajmuje:"
set "__CC_str8=Kliknij, aby wrÛciÊ do dzia≥u pomocy"
set "__CC_DefaultList=Gracze.ini"
set "__CC_Title=Tytu≥"
set "__CC_TitlePrompt= Podaj tytu≥ dla tej sesji "
set "__CC_Menu1=Zacznij turniejowanie"
set "__CC_Menu2=Ustaw liczbÍ graczy"
set "__CC_Menu3= Ustaw liczbÍ rund"
set "__CC_Menu4=Prze≥πcz liczenie Buchholza"
set "__CC_Menu5=Prze≥πcz ustawienie drukowania"
set "__CC_Menu6=Zaawansowane ustawienia"
set "__CC_Menu7=Wyjdü z programu"
set "__CC_Menu8=ZmieÒ tytu≥ okna"
set "__CC_Menu9=ZmieÒ nazwÍ pliku z listπ graczy"
set "__CC_Menu10=Prze≥πcz pokazywanie intra"
set "__CC_Menu11=Zapisz ustawienia do pliku .ini"
set "__CC_Menu12=[=] Dzia≥ pomocy [=]"
set "__CC_Menu13=WrÛÊ do g≥Ûwnego menu"
set "__CC_Menu14=Ustaw nowπ nazwÍ:"
set "__CC_Menu15=Stara:"
set "__CC_Setup1=Liczba osÛb"
set "__CC_Setup2=Podaj liczbÍ grajπcych"
set "__CC_Setup3=Liczba rund"
set "__CC_Setup4=Podaj liczbÍ rund"
set "__CC_Warning1="UWAGA" "Ustawiono (nieparzystπ) liczbÍ rund takπ samπ jak liczba osÛb" "Bardzo prawdopodobne, øe przy n-tym losowaniu wystπpi b≥πd" "krytyczny z powodu braku moøliwoúci dalszych losowaÒ" "" "Na pewno chcesz kontynuowaÊ?" "" "$$Tak" "" "$$Nie""
set "__CC_Setup5=ImiÍ osoby nr"
set "__CC_Setup6=Podaj imiÍ osoby pod nr"
set "__CC_Setup7="Imiona osÛb" "Dane:""
set "__CC_Setup8="Czy wpisane dane sπ prawid≥owe?" "" "$$Tak" "" "$$Nie""
...
set "__CC_Complete="Konfiguracja zakoÒczona." "Za chwilÍ zacznπ siÍ losowania...""
set "__CC_LosError1="Losowanie nie powiod≥o siÍ..." "$$Czy chcesz samodzielnie dobraÊ przeciwnikÛw" "...czy..." "$$ZakoÒczyÊ dzia≥anie programu?""
set "__CC_LosError2="Informacja" "Dobierz kolejne pary, opierajπc siÍ na poprzednich losowaniach rund" "System - w miarÍ moøliwoúci - bÍdzie sprawdza≥, czy takie kojarzenie jest moøliwe" "Dobieraj numerami - nie nazwami.""
set "__CC_LosError3=Pierwszy numer: "
set "__CC_LosError4=Drugi numer: "
set "__CC_LosError5=Nie moøna ustawiÊ takiego kojarzenia."
set "__CC_LosError6=Kojarzenie ustawione."
set "__CC_LosError7=KoÒczenie programu za 3 sekundy..."
set "__CC_LosMenu1="%__CC_DrawName%" "Na pewno chcesz rozpoczπÊ kolejnπ rundÍ?" "" "$$Tak" "" "$$Nie""
set "__CC_LosMenu2="%__CC_DrawName%" "Nie wpisano jeszcze wszystkich wynikÛw.""
set "__CC_LosMenu3="$$Rozpocznij kolejnπ rundÍ" "" "$$Pokaø obecne wyniki" "" "$$Zabezpiecz sesjÍ has≥em""
set "__CC_Pair=Para"
set "__CC_Nr=nr"
set "__CC_Protect1=Podaj has≥o odblokowujπce program (dozwolone: A-Z, a-z, 0-9, [SPACE])"
set "__CC_Protect2= Program jest zabezpieczony has≥em"
set "__CC_Protect3=    Podaj has≥o, by odblokowaÊ:"
set "__CC_Protect4=Has≥o nieprawid≥owe"
set "__CC_Protect5=Odblokowano"
set "__CC_Protect6=Has≥o ustawione"

set "__CC_Print=Momencik, trwa drukowanie:"
set "__CC_CTC=Kliknij, aby kontynuowaÊ"
set "__CC_ByeText="DziÍkujÍ za przyjemnπ pracÍ" "ØyczÍ mi≥ego dnia :)""
chcp 852>nul
...
for %%a in (
	...
	"- Removed [0;40;33mTest Samples[0;1;40;37m"
	""
	""
	"CreepyGames v1.4.2 (actual)"
...
set "__MenuConflict3=To solve this, launch program as administrator."
...
:CB2_load
if not exist CraftBatcher_Saves\zapis.bat goto CB2_menu
cls
call CraftBatcher_Saves\zapis.bat
set x=%x: =%
set y=%y: =%
:CB2_scr
set /a bx=%x%-4
...
set l=
for /l %%x in (%bx%,1,%ex%) do (
if "!x%%xy%%y!"=="" (set l=!l!≤) else (set l=!l!!x%%xy%%y:~0,1!)
)
echo  ∫!l!∫
)
echo  »ÕÕÕÕÕÕÕÕÕº
...
:CB2_items
for /l %%a in (1,1,9) do (set c%%a= &set z%%a=!i%%a! )
set c%i%=
cls
echo.
echo  …ÕÕÕÕÕÕÕÕÕÕª
...
if %errorlevel%==2 if not %i%==9 set /a i+=1
if %errorlevel%==3 goto CB2_scr
goto CB2_items
...
if %ktr%==1 echo 5]
choice /c 12345 /n
if %errorlevel%==1 (set skin=&goto CB2_menu)
if %errorlevel%==2 (set skin=o&goto CB2_menu)
if %errorlevel%==3 (set skin=@&goto CB2_menu)
if %errorlevel%==4 (set skin=&goto CB2_menu)
if %errorlevel%==5 if %ktr%==1 (set skin=&goto CB2_menu)
goto CB2_settings
...
:CB2_save
cd CraftBatcher_Saves || (mkdir CraftBatcher_Saves & goto CB2_save)
cls
echo Zapisywanie...
>zapis.bat (for /f %%A in ('set x') do (
echo set %%A 
))
>>zapis.bat (
echo set y=%y%
